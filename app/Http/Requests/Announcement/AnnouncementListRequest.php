...
class AnnouncementListRequest extends FormRequest
{
    /**
    ...
    public function check(): array
    {
        ...
        if (array_key_exists(MainContract::VIEW,$data)) {
            $data[MainContract::DATA][] =   [MainContract::VIEW,$data[MainContract::VIEW]];
        }
