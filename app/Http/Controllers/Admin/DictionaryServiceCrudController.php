...
use App\Http\Requests\DictionaryServiceRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class DictionaryServiceCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class DictionaryServiceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\DictionaryService::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/dictionary-service');
