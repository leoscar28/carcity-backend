...
use App\Http\Requests\DictionaryBrandRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class DictionaryBrandCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class DictionaryBrandCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\DictionaryBrand::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/dictionary-brand');
    ...
    {
        CRUD::setValidation(DictionaryBrandRequest::class);
