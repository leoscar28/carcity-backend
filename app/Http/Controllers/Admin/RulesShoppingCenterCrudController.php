...
use App\Http\Requests\RulesShoppingCenterRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

class RulesShoppingCenterCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\RulesShoppingCenter::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/rules-shopping-center');
        CRUD::setEntityNameStrings('Правила ТЦ', 'Правила ТЦ');
    }
    ...
    {
        CRUD::setValidation(RulesShoppingCenterRequest::class);
