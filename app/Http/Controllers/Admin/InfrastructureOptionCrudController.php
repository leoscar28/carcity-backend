...
use App\Http\Requests\InfrastructureOptionRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

class InfrastructureOptionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\InfrastructureOption::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/infrastructure-option');
        CRUD::setEntityNameStrings('Пункт', 'Инфраструктура пункты');
    }
    ...
    {
        CRUD::setValidation(InfrastructureOptionRequest::class);
