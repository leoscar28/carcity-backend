...
use App\Http\Requests\SliderDetailRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

class SliderDetailCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\SliderDetail::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/slider-detail');
        CRUD::setEntityNameStrings('Слайд текст', 'Слайд детали');
    }
    ...
    {
        CRUD::setValidation(SliderDetailRequest::class);
