...
use App\Http\Requests\RulesAdRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

class RulesAdCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\RulesAd::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/rules-ad');
        CRUD::setEntityNameStrings('Правила размещения объявлений', 'Правила размещения объявлений');
    }
    ...
    {
        CRUD::setValidation(RulesAdRequest::class);
