...
use App\Http\Requests\AboutOptionRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

class AboutOptionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\AboutOption::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/about-option');
        CRUD::setEntityNameStrings('Пункт', 'О нас пункты');
    }
    ...
    {
        CRUD::setValidation(AboutOptionRequest::class);
