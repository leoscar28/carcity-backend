...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create(ApplicationListContract::TABLE, function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->index(MainContract::APPLICATION_ID);
        });
    }
    ...
    {
        Schema::dropIfExists(ApplicationListContract::TABLE);
    }
};
