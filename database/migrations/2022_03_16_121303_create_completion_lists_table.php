...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create(CompletionListContract::TABLE, function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->index(MainContract::COMPLETION_ID);
        });
    }
    ...
    {
        Schema::dropIfExists(CompletionListContract::TABLE);
    }
};
